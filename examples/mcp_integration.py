    ...
    async def compare_routes(self, params: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            if not routes or not departure_date:
                return {
                    "error": "Missing required parameters: routes, departure_date"
                }
    ...
    def _format_flight_results(self, result: FlightResult) -> Dict[str, Any]:
        ...
        return {
            ...
            "summary": {
                ...
                "cheapest_price": float(result.cheapest_flight.price) if result.cheapest_flight else None,
                "fastest_duration": result.fastest_flight.total_duration_minutes if result.fastest_flight else None,
