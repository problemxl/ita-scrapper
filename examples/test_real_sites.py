...
async def test_site_access_only():
    ...
    try:
        ...
        async with ITAScrapper(headless=False, use_matrix=True, timeout=30000) as scrapper:
            print("🌐 Navigating to ITA Matrix...")
    ...
    try:
        ...
        async with ITAScrapper(headless=False, use_matrix=False, timeout=30000) as scrapper:
            print("🌐 Navigating to Google Flights...")
            await scrapper._navigate_to_flights()
