...
def parse_time(time_text: str, ref_date: date = None) -> Optional[datetime]:
...
def is_valid_date_range(start_date: date, end_date: date = None) -> bool:
...
class FlightDataParser:
    ...
    def parse_airline_code(airline_text: str) -> Tuple[str, str]:
        ...
        airline_codes = {
            ...
            'klm': 'KL', 'emirates': 'EK', 'qatar': 'QR', 'turkish': 'TK',
            'virgin atlantic': 'VS', 'virgin': 'VS'
        }
