...
class Flight(BaseModel):
    ...
    def airlines(self) -> List[str]:
        ...
        return list(set(segment.airline.code for segment in self.segments))
...
class FlightResult(BaseModel):
    ...
    def fastest_flight(self) -> Optional[Flight]:
        ...
        return min(self.flights, key=lambda f: f.total_duration_minutes) if self.flights else None
